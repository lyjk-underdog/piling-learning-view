<template>
  <div class="c-cur-level-video-player">
    <Card mainTitle="教学演示" subTitle="Teaching demonstration">
      <div class="c-cur-level-video-player_body">
        <img
          class="c-cur-level-video-player_play-icon"
          src="@/assets/img/player-icon.png"
          @click="videoDisplay = true"
        />
      </div>
    </Card>

    <Dialog :visible="videoDisplay" @close="videoDisplay = false">
      <video :src="levelInfo.videoSrc" controls></video>
    </Dialog>
  </div>
</template>
...
.c-cur-level-video-player {
  &_body {
    height: 27.75rem;
    position: relative;

    $img: "~@/assets/img/people-model.svg";
